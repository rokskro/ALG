    ...
    public static class Seeder
    {
        ...
        public static void SeedAlgorithms(IAlgorithmService svc)
        {
            ...
            var algo1 = svc.AddAlgorithm(new Algorithm {
                Name = "Caesar", Description = "Simple substitution cipher that shifts each letter in a message a fixed number of positions down or up the alphabet", Security = "bad", SecurityRating = 1, 
            ...
            var algo2 = svc.AddAlgorithm(new Algorithm {
                Name = "A1Z26", Description = "Substitution cipher that replaces each letter of the alphabet with its corresponding numerical position", Security = "bad", SecurityRating = 1,     
            ...
            var algo3 = svc.AddAlgorithm(new Algorithm {
                Name = "AES", Description = "Widely used symmetric-key encryption algorithm that employs various key lengths (128, 192, or 256 bits) to securely encrypt ", Security = "Good", SecurityRating = 5,     
             ...
             var algo4 = svc.AddAlgorithm(new Algorithm {
                Name = "Blowfish", Description = "Symmetric-key block cipher algorithm known for its flexibility in supporting various key lengths and its resistance to known cryptographic attacks,", Security = "Good", SecurityRating = 5,     
                Efficiency = "High", EfficiencyRating = 5, Speed = "fast", SpeedRating = 5,   
                DiagramUrl = "https://www.simplilearn.com/ice9/free_resources_article_thumb/process.png",
                TypeClass = "Symmetrical"
            });
            var algo5 = svc.AddAlgorithm(new Algorithm {
                Name = "RSA", Description = "Asymmetric-key encryption algorithm widely used for secure communication based on the mathematical difficulty of factoring large semiprime numbers", Security = "Good", SecurityRating = 5,     
